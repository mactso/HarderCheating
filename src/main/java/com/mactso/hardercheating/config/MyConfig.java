...
public class MyConfig {
	...
	public static int maxClicksPerSecond;
	public static int maxCraftRecipesPerSecond;
	...
	public static class Common {
		...
		public Common(ForgeConfigSpec.Builder builder) {
			...
			maxClicksPerSecond = builder.comment("Legal Max Clicks per Second (15 to 99) Default 20.")
					...
					.defineInRange("maxClicksPerSecond", () -> 20, 15, 99);

			maxCraftRecipesPerSecond = builder
					.comment("Legal Max Crafting Recipe Changes per Second (3 to 99) Default 8.")
					.translation(Main.MODID + ".config." + "maxCraftRecipesPerSecond")
					.defineInRange("maxCraftRecipesPerSecond", () -> 8, 3, 99);
			...
			ValidModSet = builder.comment("Checked Mods Name List").translation(sectionTrans + "valid_mod_set")
